...
import com.callmeadnaan.quizapp.Result
            ...
            if(mSelectedOptionPosition==0){
                ...
                when{
                  ...
                  if(question!!.correctAnswer != mSelectedOptionPosition){
                      answer(mSelectedOptionPosition,R.drawable.wrong_option_border_bg)
                  }else{
...
private fun answer(answer:Int,drawableView:Int){
    when(answer){
    1->{
        tvOptionOne?.background=ContextCompat.getDrawable(this@QuizQuestionActivity,
        drawableView)
    }
        2->{
            tvOptionTwo?.background=ContextCompat.getDrawable(this@QuizQuestionActivity,
                drawableView)
        }
        3->{
            tvOptionThree?.background=ContextCompat.getDrawable(this@QuizQuestionActivity,
                drawableView)
        }
        4->{
            tvOptionFour?.background=ContextCompat.getDrawable(this@QuizQuestionActivity,
                drawableView)
        }
